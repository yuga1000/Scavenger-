// Ghostline Clean V4.1 - Clean Main Entry Point
// File: main.js
...
class GhostlineClean {
    constructor() {
        ...
        this.logger.system('[◉] Ghostline Clean V4.1 initialized');
    }
    ...
    formatStartupMessage() {
        return `🚀 GHOSTLINE CLEAN V4.1 OPERATIONAL\n\n` +
    ...
    calculateOverallSuccessRate() {
        if (this.modules.harvester && this.modules.harvester.getSuccessRate) {
            return this.modules.harvester.getSuccessRate();
        }
        return '0%';
    }
